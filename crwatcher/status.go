...
func SetPhase(status CustomResourceStatus, phase ResourcePhase, reason ConditionReason, message string) CustomResourceStatus {
...
func StatusFor(cr *unstructured.Unstructured) CustomResourceStatus {
	...
	case map[string]interface{}:
		...
		unstructuredConverter := conversion.NewConverter(false)
		if err := unstructuredConverter.FromUnstructured(cr.Object["status"].(map[string]interface{}), &status); err != nil {
